...
public struct CoffeeShopProvider {
    static func all() -> [CoffeeShop] {
        return [
            ...
            CoffeeShop(image: "sinikupi", name: "Critoe Coffee", location: "Jl. Gandapura No. 33, Kota Bandung", review: "Affordable price, great wifi, great environment for work or hangout with friends.")
        ]
    }
}
